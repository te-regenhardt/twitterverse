...
# List of names that we also used in the scraper.py script.
# If you want to exclude an account from analysis, remove it HERE. 
# DO NOT REMOVE IT FROM THE LIST IN scraper.py 
# For explanation of example list values see scraper.py or the readme.
